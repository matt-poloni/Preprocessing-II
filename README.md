...
* [ ] <del>Fork the project into your GitHub user account</del>
* [ ] <del>Clone the forked project into a directory on your machine</del>
* [ ] <del>You are now ready to build this project with your preferred IDE</del>
